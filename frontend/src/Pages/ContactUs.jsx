  ...
  return (
    <div className="main">
      ...
      <div>
        <form onSubmit={handleSubmit} className="message-form">
          ...
          <span className="Options-flex">
            <label className={selectedCheckboxes.includes("Media Buying")?"Options-label-clicked":"Options-label"}>
              <input
            ...
            <label className={selectedCheckboxes.includes("Content Marketing")?"Options-label-clicked":"Options-label"}>
              <input
              className="hidden-checkbox"
                type="checkbox"
            ...
            <label className={selectedCheckboxes.includes("Affiliate Marketing")?"Options-label-clicked":"Options-label"}>
              <input
              className="hidden-checkbox"
                type="checkbox"
            ...
            <label className={selectedCheckboxes.includes("Media Queries")?"Options-label-clicked":"Options-label"}>
              <input
              className="hidden-checkbox"
                type="checkbox"
                value="Media Queries"
            ...
            <label className={selectedCheckboxes.includes("Lead Generation")?"Options-label-clicked":"Options-label"}>
              <input
              className="hidden-checkbox"
                type="checkbox"
            ...
            <label className={selectedCheckboxes.includes("Careers")?"Options-label-clicked":"Options-label"}>
              <input
              className="hidden-checkbox"
                type="checkbox"
                value="Careers"
            ...
            <label className={selectedCheckboxes.includes("Others")?"Options-label-clicked":"Options-label"}>
              <input
              className="hidden-checkbox"
                type="checkbox"
                value="Others"
      ...
      <div className="Location-section">
          ...
          <span className="Location-card-box">
            <span className="Card-flex">
            <div>
                <img src="" alt="location" />
                <h1>United States</h1>
                <p>2035 Sunset Lake RD,STE B2, Newark – 19702
