...
export default function FounderCard({
  ...
  return (
    <div className="w-[90%] sm:w-[75%] md:w-auto md:basis-[46%] lg:basis-[33%] shadow-lg hover:cursor-pointer rounded-2xl overflow-hidden ceo-container">
      <img src={imageSrc} alt={founderName} className="ceo-image"/>

      <div className={`w-fit min-w-[50%] pl-2 md:pl-3 pr-4 md:pr-6 py-1 mt-1.5 rounded-r-full ${index&1 ? "bg-secondary-500 text-tertiary-500" : "bg-primary-500 text-secondary-500"} whitespace-nowrap text-lg sm:text-2xl font-semibold relative z-10`}>
        {founderName}
      </div>
