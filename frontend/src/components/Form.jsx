...
const Form = () => {
  ...
  const [validator,setValidator]=useState({isName:true,isContact:true,isEmail:true,isMessage:true,isOptions:true})
  ...
  return (
    <div className="flex-col py-3">
      <div className="flex-col gap-6 py-4">
       ...
       <span className={isOptions===true?"hidden":"block"}>This field is Required</span>
        </div>
          <div >
            {/* Input form */}
