...
export default function ExploreBlogList({blog, focus, className}) {
  ...
  return (
    ...
    >
      ...
      <Button className="mx-4 -translate-x-2 justify-self-end hover:text-tertiary-500 pl-0 hover:scale-x-150" arrow arrowWhite={hover ? true : false}>learn more</Button>
