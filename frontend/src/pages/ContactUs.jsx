  ...
  return (
    <>
      <div className="flex flex-col px-screen-padding py-10 relative">
        <Heading heading="Let's Create" subHeading="Progress Together" />
        ...
        <div className="mt-12 flex gap-10 lg:gap-16 justify-between items-center lg:items-start">
          ...
          <img
            ...
            alt=""
            className="mb-8 hidden md:w-[40vw] md:block"
          />
        </div>
      ...
      <img className="wave-image" src="./assets/triple-wave-white-1.svg" />
      ...
      <Section
        ...
        illustration={
          <div className="w-full lg:w-auto flex flex-col md:flex-row items-center justify-evenly lg:justify-between lg:items-start md:gap-16">
            <ServicesCards
              ...
              text={
                <>
                  402,Kuber House <br /> 162,Kanchan Bagh,Indore <br /> Madhya
                  Pradesh - 452001
                  <br />
                  <br />
                  <span className="text-secondary-500">
                    business@armediahouse.in
                  </span>
                </>
              }
              ...
              button={
                <Button
                  to="https://maps.app.goo.gl/44zPJFBY2Po67QRr5"
                  className="bg-primary-500 absolute bottom-[-5%]"
                >
                  Get Direction
                </Button>
              }
        ...
        Shapes={<Triangle className="top-[-10%] left-[25%]" />}
      />
