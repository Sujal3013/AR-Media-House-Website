...
<Navbar/>
    ...
    <div className="text-center">
      ...
      <p className="text-2xl text-secondary-500">Page Not Found</p>
      <p className="mt-4 text-secondary-500">The page you are looking for might be in another universe.</p>
